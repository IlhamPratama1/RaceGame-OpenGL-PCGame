...
int main() {
	...
	GLFWwindow* window = glfwCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, "Tutorial Teori 4 : 4210181020 Ilham Pratama", NULL, NULL);
	...
	int image_width1 = 0;
	int image_height1 = 0;
	unsigned char* image1 = SOIL_load_image("Images/backdrop.jpg", &image_width1, &image_height1, NULL, SOIL_LOAD_RGBA);
